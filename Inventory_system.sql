...
-- 插入订货单数据
INSERT INTO PurchaseOrders (po_id, order_date, expected_delivery_date, status, total_cost) VALUES
(1, '2024-01-10', '2024-01-20', 'Delivered', 122000),
(2, '2024-01-12', '2024-01-22', 'Delivered', 43000),
(3, '2024-01-14', '2024-01-24', 'Shipped', 65000),
(4, '2024-01-16', '2024-01-26', 'Processing', 41500),
(5, '2024-01-18', '2024-01-28', 'Delivered', 65000),
(6, '2024-01-20', '2024-01-30', 'Shipped', 86000),
(7, '2024-01-22', '2024-02-01', 'Processing', 28750),
(8, '2024-01-24', '2024-02-03', 'Delivered', 51000),
(9, '2024-01-26', '2024-02-05', 'Delivered', 59500),
(10, '2024-01-28', '2024-02-07', 'Shipped', 48000),
(11, '2024-01-30', '2024-02-09', 'Processing', 145000),
(12, '2024-02-01', '2024-02-11', 'Delivered', 85500),
(13, '2024-02-03', '2024-02-13', 'Delivered', 57000),
(14, '2024-02-05', '2024-02-15', 'Delivered', 43000),
(15, '2024-02-07', '2024-02-17', 'Shipped', 65000),
(16, '2024-02-09', '2024-02-19', 'Processing', 41500),
(17, '2024-02-11', '2024-02-21', 'Delivered', 65000),
(18, '2024-02-13', '2024-02-23', 'Shipped', 86000),
(19, '2024-02-15', '2024-02-25', 'Processing', 28750),
(20, '2024-02-17', '2024-02-27', 'Delivered', 51000),
(21, '2024-02-19', '2024-03-01', 'Delivered', 59500),
(22, '2024-02-21', '2024-03-03', 'Shipped', 48000),
(23, '2024-02-23', '2024-03-05', 'Processing', 145000),
(24, '2024-02-25', '2024-03-07', 'Delivered', 85500),
(25, '2024-02-27', '2024-03-09', 'Delivered', 57000),
(26, '2024-02-29', '2024-03-11', 'Delivered', 43000),
(27, '2024-03-02', '2024-03-12', 'Shipped', 65000),
(28, '2024-03-04', '2024-03-14', 'Processing', 41500),
(29, '2024-03-06', '2024-03-16', 'Delivered', 65000),
(30, '2024-03-08', '2024-03-18', 'Shipped', 86000),
(31, '2024-03-10', '2024-03-20', 'Processing', 28750),
(32, '2024-03-12', '2024-03-22', 'Delivered', 51000),
(33, '2024-03-14', '2024-03-24', 'Delivered', 59500),
(34, '2024-03-15', '2024-03-26', 'Processing', null);
...
(87, 1, 2, 50, 60000),  -- Supplier 2, Laptop x50, cost: 1200 each
(88, 1, 3, 70, 87500),  -- Supplier 3, Laptop x70, cost: 1250 each
(89, 34, 2, 100, null); -- Failed to buy 100 laptops from supplier 2

-- 插入39条假数据到WarehouseTransfers表 liuyi
-- 清空已有的 WarehouseTransfers 数据  ----NOTE 如果准备在本地多次测试的话请酌情comment掉这条，可能造成数据清空
